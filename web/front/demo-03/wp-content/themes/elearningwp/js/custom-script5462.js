(function ($) {
	...
	var menu_landing = function () {
		...
		var $scrollOffset = $("#landing-desc").offset();
		if (jQuery(".menu-scoll-landing").length) {
			$window.scroll(function () {
				if ($window.scrollTop() > $scrollOffset.top) {
					$('.menu-scoll-landing').addClass('slideDown');
					$('.menu-landing-courses').addClass('slideUp');
				} else {
					$('.menu-scoll-landing').removeClass('slideDown');
					$('.menu-landing-courses').removeClass('slideUp');
				}
			});
		...
		scrollHandler = function () {
			...
			jQuery('.tab-btns a[href*=#]').each(function () {
				...
				if (jQuery(thisHref).length) {
					...
					var thisPosition = thisTruePosition - (jQuery(".menu-scoll-landing").height() + admin_height);
